...
impl TryFrom<u8> for TypedOpcode {
    ...
    fn try_from(value: u8) -> Result<Self, Self::Error> {
        ...
        match value {
            ...
            0x79 => Ok(TypedOpcode::Reserved4), // 保留给未来使用
            0x7A => Ok(TypedOpcode::NewListWithCap),
            0x7B => Ok(TypedOpcode::ArcNew),
            0x7C => Ok(TypedOpcode::ArcClone),
            0x7D => Ok(TypedOpcode::ArcDrop),
