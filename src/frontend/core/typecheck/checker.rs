...
use crate::frontend::core::types::computation::const_generics::eval::{ConstFunction, ConstExpr};
...
impl TypeChecker {
    ...
    fn register_predefined_const_functions(env: &mut TypeEnvironment) {
        use crate::frontend::core::types::computation::const_generics::eval::ConstBinOp;
