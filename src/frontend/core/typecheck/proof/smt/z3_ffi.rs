...
#[repr(C)]
pub struct Z3_config_struct {
    _unused: [u8; 0],
}
#[repr(C)]
pub struct Z3_context_struct {
    _unused: [u8; 0],
}
#[repr(C)]
pub struct Z3_solver_struct {
    _unused: [u8; 0],
}
#[repr(C)]
pub struct Z3_sort_struct {
    _unused: [u8; 0],
}
#[repr(C)]
pub struct Z3_ast_struct {
    _unused: [u8; 0],
}
#[repr(C)]
pub struct Z3_app_struct {
    _unused: [u8; 0],
}
#[repr(C)]
pub struct Z3_func_decl_struct {
    _unused: [u8; 0],
}
#[repr(C)]
pub struct Z3_model_struct {
    _unused: [u8; 0],
}
#[repr(C)]
pub struct Z3_symbol_struct {
    _unused: [u8; 0],
}
...
extern "C" {
    ...
    pub fn Z3_solver_inc_ref(
        c: Z3_context,
        s: Z3_solver,
    );
    pub fn Z3_solver_dec_ref(
        c: Z3_context,
        s: Z3_solver,
    );
    pub fn Z3_solver_assert(
        c: Z3_context,
        s: Z3_solver,
        a: Z3_ast,
    );
    pub fn Z3_solver_check(
        c: Z3_context,
        s: Z3_solver,
    ) -> i32;
    pub fn Z3_solver_get_model(
        c: Z3_context,
        s: Z3_solver,
    ) -> Z3_model;
    #[allow(dead_code)]
    pub fn Z3_solver_get_reason_unknown(
        c: Z3_context,
        s: Z3_solver,
    ) -> Z3_string;
}
...
extern "C" {
    pub fn Z3_model_inc_ref(
        c: Z3_context,
        m: Z3_model,
    );
    pub fn Z3_model_dec_ref(
        c: Z3_context,
        m: Z3_model,
    );
    pub fn Z3_model_get_num_consts(
        c: Z3_context,
        m: Z3_model,
    ) -> u32;
...
extern "C" {
    pub fn Z3_get_decl_name(
        c: Z3_context,
        d: Z3_func_decl,
    ) -> Z3_symbol;
    pub fn Z3_get_symbol_string(
        c: Z3_context,
        s: Z3_symbol,
    ) -> Z3_string;
}
