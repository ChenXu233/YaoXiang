...
pub struct BumpAllocator {
    ...
    /// Total capacity
    capacity: usize,
    /// Memory buffer (exposed for VM memory operations)
    pub buffer: Vec<u8>,
}
...
impl BumpAllocator {
    ...
    /// Get mutable access to the internal buffer for VM memory operations
    /// Used by VM for random access memory operations
