...
use crate::middle::lifetime::error::OwnershipCheck;
use crate::middle::lifetime::{MutChecker, OwnershipChecker, OwnershipError};
...
fn test_mutable_var_assignment_allowed() {
    ...
    let store_instructions = vec![Instruction::Store {
        dst: Operand::Local(0),
        src: Operand::Const(crate::middle::ir::ConstValue::Int(42)),
    }];
...
fn test_immutable_store_index_error() {
    ...
    let instructions = vec![Instruction::StoreIndex {
        dst: Operand::Local(0),
        index: Operand::Const(crate::middle::ir::ConstValue::Int(0)),
        src: Operand::Const(crate::middle::ir::ConstValue::Int(42)),
    }];
...
fn test_immutable_mutation_method_error() {
    ...
    let instructions = vec![Instruction::Call {
        dst: None,
        func: Operand::Const(crate::middle::ir::ConstValue::String("push".to_string())),
        args: vec![
            Operand::Local(0),
            Operand::Const(crate::middle::ir::ConstValue::Int(42)),
        ],
    }];
...
fn test_mutable_mutation_method_allowed() {
    ...
    let instructions = vec![Instruction::Call {
        ...
        func: Operand::Const(crate::middle::ir::ConstValue::String("concat".to_string())),
        args: vec![
            Operand::Local(0),
            Operand::Const(crate::middle::ir::ConstValue::Int(42)),
        ],
...
fn test_mut_checker_clear() {
    ...
    let func3 = create_test_function(vec![
        ...
        Instruction::Store {
            dst: Operand::Local(1),
            src: Operand::Const(crate::middle::ir::ConstValue::Int(43)),
        },
    ]);
...
fn test_is_mutation_method() {
    use crate::middle::lifetime::mut_check::is_mutation_method;
...
fn test_all_mutation_methods_error() {
    ...
    for method in mutation_methods {
        ...
        let instructions = vec![Instruction::Call {
            dst: None,
            func: Operand::Const(crate::middle::ir::ConstValue::String(method.to_string())),
...
fn test_multiple_immutable_assignments() {
    ...
    let instructions = vec![
        Instruction::Store {
            dst: Operand::Local(0),
            src: Operand::Const(crate::middle::ir::ConstValue::Int(1)),
        },
        Instruction::Store {
            dst: Operand::Local(1),
            src: Operand::Const(crate::middle::ir::ConstValue::Int(2)),
        },
        Instruction::Store {
            dst: Operand::Temp(0),
            src: Operand::Const(crate::middle::ir::ConstValue::Int(3)),
        },
    ];
...
fn test_method_call_with_non_target_args() {
    ...
    let instructions = vec![Instruction::Call {
        ...
        func: Operand::Const(crate::middle::ir::ConstValue::String("push".to_string())),
        args: vec![
            Operand::Const(crate::middle::ir::ConstValue::Int(1)),
            Operand::Local(0),
        ],
    }];
