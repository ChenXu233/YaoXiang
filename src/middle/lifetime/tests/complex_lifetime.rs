...
fn test_conditional_lifetime_both_branches() {
    ...
    let else_instructions = vec![
        Instruction::Store {
            dst: Operand::Local(0),
            src: Operand::Const(crate::middle::ir::ConstValue::Int(24)),
        },
        Instruction::Ret(Some(Operand::Local(0))),
    ];
    ...
    let func = FunctionIR {
        ...
        blocks: vec![BasicBlock {
            ...
            instructions: vec![
                ...
                // 早期释放
                Instruction::Ret(Some(Operand::Const(crate::middle::ir::ConstValue::Int(42)))),
            ],
            successors: vec![],
        }],
        entry: 0,
    ...
    let func = FunctionIR {
        ...
        blocks: vec![BasicBlock {
            ...
            instructions: vec![Instruction::Ret(Some(Operand::Const(
                crate::middle::ir::ConstValue::Int(42),
            )))],
            successors: vec![],
        }],
        entry: 0,
