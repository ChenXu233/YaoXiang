...
use crate::middle::ir::{Instruction, Operand};
use crate::middle::lifetime::error::{OwnershipCheck, OwnershipError};
...
fn test_use_after_move_in_eq() {
    ...
    func.blocks[0].instructions = vec![
        ...
        Instruction::Eq {
            dst: Operand::Temp(1),
            lhs: Operand::Local(0),
            rhs: Operand::Const(crate::middle::ir::ConstValue::Int(0)),
        },
    ];
