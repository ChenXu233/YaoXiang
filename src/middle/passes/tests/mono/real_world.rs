...
fn test_generic_option() {
    ...
    mono.test_insert_generic_function(some_id.clone(), ir);
...
fn test_generic_result() {
    ...
    mono.test_insert_generic_function(ok_id.clone(), ir);
...
fn test_generic_list_operations() {
    ...
    mono.test_insert_generic_function(map_id.clone(), ir);
...
fn test_generic_dict_operations() {
    ...
    mono.test_insert_generic_function(get_id.clone(), ir);
...
fn test_filter_higher_order_function() {
    ...
    mono.test_insert_generic_function(filter_id.clone(), ir);
...
fn test_reduce_higher_order_function() {
    ...
    mono.test_insert_generic_function(reduce_id.clone(), ir);
...
fn test_sort_function() {
    ...
    mono.test_insert_generic_function(sort_id.clone(), ir);
...
fn test_map_closure() {
    ...
    let instance = ClosureInstance::new(
        ...
        closure_id.clone(),
        vec![],
        vec![crate::middle::passes::mono::instance::CaptureVariable::new(
            "x".to_string(),
            int_type(),
            Operand::Local(0),
        )],
...
fn test_comparable_constraint() {
    ...
    mono.test_insert_generic_function(max_id.clone(), ir);
...
fn test_hashable_constraint() {
    ...
    mono.test_insert_generic_function(hash_id.clone(), ir);
...
fn test_iterable_constraint() {
    ...
    mono.test_insert_generic_function(iter_id.clone(), ir);
...
fn test_callback_pattern() {
    ...
    mono.test_insert_generic_function(on_click_id.clone(), ir);
...
fn test_event_handler_pattern() {
    ...
    mono.test_insert_generic_function(handler_id.clone(), ir);
...
fn test_async_callback_pattern() {
    ...
    mono.test_insert_generic_function(then_id.clone(), ir);
...
fn test_chain_pattern() {
    ...
    mono.test_insert_generic_function(pipe_id.clone(), ir);
...
fn test_try_pattern() {
    ...
    mono.test_insert_generic_function(try_id.clone(), ir);
...
fn test_catch_pattern() {
    ...
    mono.test_insert_generic_function(catch_id.clone(), ir);
...
fn test_cache_effectiveness() {
    ...
    mono.test_insert_generic_function(id.clone(), ir);
...
fn test_empty_list_handling() {
    ...
    mono.test_insert_generic_function(first_id.clone(), ir);
...
fn test_default_parameter_pattern() {
    ...
    mono.test_insert_generic_function(with_default_id.clone(), ir);
