...
| **P6** | unsafe | unsafe 代码块 + 裸指针 | P5 | v0.5+ | ⏳ 后期 |
| **P7** | Monomorphize | generic AST → 特化 AST | P3 | v0.4+ | 🔶 待开始 |

### 第二部分：运行时 Core 组件（必须，v0.3-v0.4）
...
| **P11** | VM | 字节码解释器 | P8-P10 | v0.4+ | ⚠️ 基础 |

### 第三部分：后期扩展（v0.5+）

| Phase | 组件 | 说明 | 依赖 | 版本 | 状态 |
|-------|------|------|------|------|------|
| **P12** | Embedded Runtime | 即时执行器，无 DAG 调度 | P8 | v0.5+ | ⏳ 后期 |
| **P13** | WorkStealer | 工作窃取（负载均衡） | P10 | v0.5+ | ⏳ 后期 |
| **P14** | @block | 标准库强制同步执行 | P11-P13 | v0.5+ | ⏳ 后期 |
| **P15** | Stdlib | 标准库（core/io/net 等） | P11 | v0.5+ | ⚠️ 基础 |
| **P16** | JIT Compiler | 热点代码编译 | P11 | v0.7+ | ⏳ 后期 |
| **P17** | Debugger | 断点/单步/变量检查 | P11 | v0.7+ | ⏳ 后期 |
| **P18** | Bootstrap | 自举编译 | P1-P17 | v0.9+ | ⏳ 后期 |
| **P19** | AOT Compiler | AOT 机器码编译 | P18 | v1.0+ | ⏳ 后期 |
