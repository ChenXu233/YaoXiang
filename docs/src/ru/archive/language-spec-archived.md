> **注意：本文档已归档，不再维护。**
> **请参考新的语言规范文档：[语言-spec](../reference/language-spec/index.md)**
...
> Автор：晨煦
> Дата：2024-12-31
> Обновление：2026-02-22 - 元类型 не является ключевым словом.
...
满足本文档中定义的所有规则的程序或实现，被视为符合 YaoXiang 规范的。
...
| Зарезервированное слово | Тип | 说明 |
|--------|------|------|
| `Type` | Type | 元类型 |
| `true` | Bool | 布尔真值 |
| `false` | Bool | 布尔假值 |
...
## Глава 8 (Продолжение): Ограничения 类型系统
