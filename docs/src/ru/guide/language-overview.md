...
Поймите основной синтаксис YaoXiang за 5 минут. Для углублённого изучения посетите
...
Нет ключевых слов `type`, `struct`, `trait`, `impl`. Всё выполняется одним унифицированным
объявлением.
