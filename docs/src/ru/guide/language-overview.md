...
Изучите основной синтаксис YaoXiang за 5 минут. Для углублённого изучения посетите
[учебник](../../tutorial/index.md).
...
Всё есть `name: type = value`. Функции тоже значения.
...
Нет ключевых слов `type`, `struct`, `trait`, `impl`. Одно унифицированное объявление покрывает всё.
...
spawn — единственная примитива параллелизма. Никаких async/await, никаких Send/Sync.
