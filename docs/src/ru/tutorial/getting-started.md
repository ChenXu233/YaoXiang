...
>
> **Примечание**: примеры кода в данном документе основаны на спецификации языка YaoXiang. Если при фактическом выполнении вы столкнётесь с различиями в синтаксисе, обратитесь к [спецификации языка](../reference/language-spec/index.md).
...
**Ключевое правило**: выражение, модифицированное через `spawn`, выполняется в фоне, а внешний синхронный код блокируется в ожидании результата. Независимые задачи выполняются параллельно и планируются средой выполнения на основе модели GMP.
...
- 📚 Изучите [спецификацию языка](../YaoXiang-language-specification.md), чтобы узнать полный синтаксис
