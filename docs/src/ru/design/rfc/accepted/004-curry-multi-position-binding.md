```yaml
---
title: "RFC-004：设计多位置联合绑定 для каррированных методов"
---

# RFC-004: 设计多位置联合绑定 для каррированных методов
...
当函数参数数量 > 绑定位置数量时，自动生成 каррированная 函数：
...
- **无 `self` 关键字**：保持语言简洁性
- **Каррирование 友好**：天然支持部分应用和链式调用
- **OOP 友好**：自动 каррирование 让 OOP 程序员无脑迁移
