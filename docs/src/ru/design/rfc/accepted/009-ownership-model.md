---
title: RFC-009：设计 модели владения
---

# RFC-009: 设计 модели владения

> **Статус**: 已接受
> **作者**: 晨煦
> **创建日期**: 2025-01-08
> **最后更新**: 2026-05-29（用令牌系统替代丐版借用，统一类型系统）

## 摘要

本文档定义 YaoXiang 编程语言的**模型 владения（Ownership Model）**。
