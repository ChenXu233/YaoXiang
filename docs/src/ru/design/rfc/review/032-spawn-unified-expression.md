---
title: 'RFC-032: Унифицированная модификация выражений spawn — устранение исключительности spawn for'
