title: "Использование командной строки yaoxiang format" description: Параметры командной строки и
способы использования инструмента форматирования
---
...
- [Спецификация написания тестов](../../dev/test-specification.md)
