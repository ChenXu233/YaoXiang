...
`yaoxiang.toml` — это манифестный файл проекта YaoXiang, объявляющий метаданные проекта и зависимости.
...
| `version` | string | Да | Семантический номер версии, соответствующий спецификации semver |
...
authors = ["Иван Иванов <ivanov@example.com>"]
license = "MIT"
```
