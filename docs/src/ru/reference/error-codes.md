...
сопоставление с образцом, инстанцирование дженериков, семантику параллелизма и распространение
ошибок.
...
| E1091 | `Generic meta-type self-reference is not allowed: '{decl}'`                    | Недопустимый метатип дженерика                         |
...
| E2094 | `Invalid signature: generic '{name}' shadows outer generic`              | Затенение дженерика                           |
| E2095 | `Invalid signature: parameter '{name}' shadows generic`                  | Имя параметра затеняет дженерик               |
...
| E6006 | `Function not found: '{func}'`                                      | Функция не найдена (во время выполнения) |
...
| W1063 | `Const generic constraint not evaluable at compile time` | Ограничение const-дженерика не
