...
**Сообщение**: Указанная переменная не определена
...
**Сообщение**: Ожидаемый тип не совпадает с фактическим типом
...
**Сообщение**: Указанный тип не существует

**Помощь**: Проверьте правильность написания имени типа

---

## E1010: Несовпадение количества параметров
...
**Сообщение**: Тип возврата функции неверен
...
## E1020: Тип не может быть выведен
...
## E1021: Конфликт при выводе типа
...
## E1041: Индекс за границами

**Категория**: TypeCheck

**Сообщение**: Индекс массива/списка выходит за пределы диапазона
