...
> バージョン：v0.1.0-draft著者：晨煦日付：2024-12-31ステータス：[アーカイブ済み] 本ドキュメントは初期概念設計であり、正式なドキュメントに置き換えられました。
...
✅ **実行可能** -
KotlinのコルーチンやRustのasync/awaitに類似するが、コンパイル時解析で自動管理することで、程序员の負担を軽減。
