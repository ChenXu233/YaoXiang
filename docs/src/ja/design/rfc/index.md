...
> RFC（Request for Comments）は、YaoXiang言語の特性設計に関する提案を正式に提出するフォーマットです。
...
| 番号 | タイトル | 著者 | 作成日 | ステータス |
|------|------|------|----------|------|
| RFC-026a | [RFC-026a: 拡張可能な FFI メカニズム体系](./review/026a-extensible-ffi-system.md) | 晨煦 | 2026-07-03 | レビュー中 |
| RFC-032 | [RFC-032: spawn 統一式修飾 — spawn for 特殊ケースの排除](./review/032-spawn-unified-expression.md) | 晨煦 | 2026-06-16 | レビュー中 |
...
| 番号 | タイトル | 著者 | 作成日 | ステータス |
|------|------|------|----------|------|
| RFC-004 | [RFC-004: カリー化メソッドの複数位置結合設計](./accepted/004-curry-multi-position-binding.md) | 晨煦 | 2025-01-05 | 承認済み |
...
| ↳ RFC-014a | [RFC-014a: Registry プロトコル仕様](./review/014a-registry-protocol.md) | 晨煦 | 2026-06-11 | レビュー中 |
...
| RFC-030 | [RFC-030: assert 機構](./accepted/030-assert-mechanism.md) | 晨煦 | 2026-06-15 | 承認済み |
...
| RFC-022 | [RFC 022: ホーア論理による静的検証サポート（仕様アノテーションと仕様型）](./deprecated/022-hoare-logic-static-verification.md) | 晨煦 | 2026-03-16 | 廃止（RFC-027 に置き換え） |
...
| RFC-005 | [RFC-005: 自動 CVE セキュリティ検査システム](./rejected/005-automated-cve-scanning.md) | 晨煦 | 2025-01-05 | 却下 |
| RFC-016 | [RFC 016: 量子ネイティブサポートとマルチバックエンド統合](./rejected/016-quantum-native-support.md) | 晨煦 | 2026-02-13 | 却下 |
| RFC-025 | [RFC-025: 拡張可能プリミティブ型機構](./rejected/025-primitive-extension.md) | 晨煦 | 2026-06-05 | 却下（RFC-026 の不透明ハンドルによりカバー） |
...
3. `番号-説明的タイトル.md` という名前で新しいファイルを作成する
4. ファイルを `docs/src/design/rfc/draft/` ディレクトリに配置する
5. 本索引ファイルを更新し、新しいRFCエントリを追加する
