...
# YaoXiang RFC（リクエストフォーコメント）インデックス
...
| -------- | -------------------------------------------------------------------------------------------------------- | ---- | ---------- | ---------- |
| RFC-002  | [RFC-002：libuv ベースのリソース型 IO 実装レイヤー](./draft/002-cross-platform-io-libuv.md)              | 晨煦 | 2026-01-05 | ドラフト   |
...
| RFC-037    | [RFC-037: 工業化ディストリビューション方案 — cargo-dist ベースのコンパイラ/ツールチェーンパッケージング](./accepted/037-industrial-packaging.md) | ChenXu233 | 2026-07-26 | 承認済み           |
...
| RFC-025 | [RFC-025: 拡張可能プリミティブ型機構](./rejected/025-primitive-extension.md)                      | 晨煦 | 2026-06-05 | 拒否       |
...
| **廃止**       | `rfc/deprecated/` | 過去に承認されたが、新しい設計に置換     |
...
5. 本インデックスファイルを更新して、新しいRFCエントリを追加する
