...
| RFC-028 | [RFC-028：JIT コンパイラ — VM 内多段階実行エンジン](./draft/028-jit-compiler.md) | 晨煦 | 2026-06-11 | ドラフト |
...
| RFC-031 | [RFC-031：最適化レベルと Pass 管理器](./draft/031-optimization-levels.md) | 晨煦 | 2026-06-16 | ドラフト |
...
| RFC-026 | [RFC-026：FFI 中核機構](./review/026-ffi-core-mechanism.md) | 晨煦 | 2026-06-05 | レビュー中 |
...
| **廃止** | `rfc/deprecated/` | かつて承認されたが、新しい設計に置き換えられた |
...
5. 本インデックスファイルを更新し、新規 RFC エントリを追加する
6. PR を提出してレビュープロセスへ進む
