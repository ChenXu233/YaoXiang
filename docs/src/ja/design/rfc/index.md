...
> RFC（Request for Comments）は、YaoXiang言語の機能設計提案の正式な提出形式です。
...
| RFC-030 | [RFC-030：assert アサーションメカニズム](./draft/030-assert-mechanism.md) | 晨煦 | 2026-06-15 | ドラフト |
| RFC-031 | [RFC-031：最適化レベルと Pass マネージャー](./draft/031-optimization-levels.md) | 晨煦 | 2026-06-16 | ドラフト |
| RFC-032 | [RFC-032：spawn 統一式修飾子](./draft/032-spawn-unified-expression.md) | 晨煦 | 2026-06-16 | ドラフト |
...
| 番号 | タイトル | 著者 | 作成日 | ステータス |
|------|------|------|----------|------|
| RFC-025 | [RFC-025: 拡張可能プリミティブ型メカニズム](./review/025-primitive-extension.md) | 晨煦 | 2026-06-05 | レビュー中 |
...
| 番号 | タイトル | 著者 | 作成日 | ステータス |
|------|------|------|----------|------|
| RFC-001 | [RFC-001：spawn モデルとエラー処理システム](./deprecated/001-concurrent-model-error-handling.md) | 晨煦 | 2025-01-05 | 廃止（RFC-024 に置き換え） |
...
| **廃止** | `rfc/deprecated/` | 一度承認されたが、新しい設計に置き換えられた |
| **拒否** | `rfc/rejected/` | 却下されたRFC文書 |
...
3. 新規ファイルを作成し、`番号-説明的なタイトル.md` という名前にする
