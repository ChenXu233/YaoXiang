...
| RFC-035  | [RFC-035: MCP Serverサポート（AI Agent統合）](./draft/035-mcp-server.md)                                                                               | Chen Xu   | 2026-07-11 | ドラフト               |
| RFC-036  | [RFC-036: std.testテストフレームワークと yaoxiang testコマンド](./draft/036-test-framework.md)                                                         | 晨煦      | 2026-07-25 | ドラフト               |
| RFC-037  | [RFC-037: 産業化ディストリビューションソリューション — cargo-distベースのコンパイラ/ツールチェーンパッケージング](./draft/037-industrial-packaging.md) | ChenXu233 | 2026-07-26 | ドラフト               |
...
| RFC-032  | [RFC-032: spawn統一式修飾子 — spawn for特例の廃止](./review/032-spawn-unified-expression.md) | 晨煦 | 2026-06-16 | レビュー中 |
...
| RFC-008    | [RFC-008：Runtime並列モデルとスケジューラの疎結合設計](./accepted/008-runtime-concurrency-model.md)           | 晨煦    | 2025-01-05 | 承認済み      |
...
| RFC-011    | [RFC-011: ジェネリックシステム設計 - ゼロコスト抽象化とマクロ代替](./accepted/011-generic-type-system.md)     | 晨煦    | 2025-01-25 | 承認済み      |
...
| RFC-024    | [RFC-024：spawnブロックベースの並列モデル](./accepted/024-concurrency-model.md)                               | 晨煦    | 2026-06-05 | 承認済み      |
...
| RFC-030    | [RFC-030: assertアサーション機構](./accepted/030-assert-mechanism.md)                                         | 晨煦    | 2026-06-15 | 承認済み      |
...
| 番号    | タイトル                                                                                                                | 著者 | 作成日     | ステータス                |
| ------- | ----------------------------------------------------------------------------------------------------------------------- | ---- | ---------- | ------------------------- |
| RFC-001 | [RFC-001：並列モデルとエラーハンドリングシステム](./deprecated/001-concurrent-model-error-handling.md)                  | 晨煦 | 2025-01-05 | 廃止（RFC-024に置き換え） |
...
| RFC-022 | [RFC 022: Hoare論理静的検証サポート（仕様アノテーションと仕様型）](./deprecated/022-hoare-logic-static-verification.md) | 晨煦 | 2026-03-16 | 廃止（RFC-027に置き換え） |
...
| RFC-025 | [RFC-025: 拡張可能プリミティブ型メカニズム](./rejected/025-primitive-extension.md)                  | 晨煦 | 2026-06-05 | 拒否（RFC-026の不透明ハンドルでカバー） |
...
| **廃止** | `rfc/deprecated/` | かつて承認されたが、新しい設計に置き換えられた | | **拒否** |
...
3. 新規ファイルを `番号-説明的なタイトル.md` という名前で作成する
