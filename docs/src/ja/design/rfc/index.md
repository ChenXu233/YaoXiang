...
| RFC-032  | [RFC-032: spawn統一式修飾 — spawn for特例の除去](./review/032-spawn-unified-expression.md) | 晨煦 | 2026-06-16 | レビュー中 |
...
| RFC-011    | [RFC-011: genericsシステム設計 - ゼロコスト抽象とマクロ代替](./accepted/011-generic-type-system.md)           | 晨煦    | 2025-01-25 | 承認済み      |
...
| 番号    | タイトル                                                                                                       | 著者 | 作成日     | ステータス                    |
| ------- | -------------------------------------------------------------------------------------------------------------- | ---- | ---------- | ----------------------------- |
| RFC-001 | [RFC-001：spawnモデルとerror propagationシステム](./deprecated/001-concurrent-model-error-handling.md)         | 晨煦 | 2025-01-05 | 廃止済み（RFC-024に置き換え） |
...
| RFC-022 | [RFC 022: Hoare論理静的検証サポート（仕様注釈と仕様型）](./deprecated/022-hoare-logic-static-verification.md)  | 晨煦 | 2026-03-16 | 廃止済み（RFC-027に置き換え） |
...
| RFC-016 | [RFC 016: 量子ネイティブサポートとマルチバックエンド統合](./rejected/016-quantum-native-support.md) | 晨煦 | 2026-02-13 | 却下済み                                  |
| RFC-025 | [RFC-025: 拡張可能プリミティブ型機構](./rejected/025-primitive-extension.md)                        | 晨煦 | 2026-06-05 | 却下済み（RFC-026不透明ハンドルにカバー） |
