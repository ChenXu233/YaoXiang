...
> **作者**: 晨煦
> **创建日期**: 2025-01-25
> **最后更新**: 2026-03-21（更新为统一 Binding 语法）
...
**示例**：
```yaoxiang
Array: (T: Type, N: Int) -> Type = { data: T[N] }
...
# 类型定义（统一 Binding 语法）
generic_type ::= identifier ':' 'Type' generic_params? '=' type_expression
