...
Before calling an FFI function, the caller must ensure the target function is reentrant. The runtime does not perform automatic detection — this is an impossible problem to solve statically.
