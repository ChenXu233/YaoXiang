...
|------|------|------|----------|------|
| RFC-019 | [RFC-019: Typed Homoiconicity — Syntax as Type](./draft/019-typed-homoiconicity.md) | 晨煦 | 2026-02-20 | Draft |
...
| RFC-032 | [RFC-032: spawn Unified Expression Modifier — Eliminating spawn for Special Case](./draft/032-spawn-unified-expression.md) | 晨煦 | 2026-06-16 | Draft |
...
| **Accepted** | `rfc/accepted/` | Becomes official design document and enters implementation phase |
