...
| ↳ RFC-009a | [RFC-009a: Token Lifetime Analysis — Hoare-style Proof Pipeline](./accepted/009a-borrow-proof-pipeline.md) | Chen Xu | 2026-06-13 | Accepted |
...
| RFC-011 | [RFC-011: Generics System Design - Zero-Cost Abstractions and Macro Replacement](./accepted/011-generic-type-system.md) | Chen Xu | 2025-01-25 | Accepted |
...
| RFC-025 | [RFC-025: Extensible Primitive Type Mechanism](./rejected/025-primitive-extension.md) | Chen Xu | 2026-06-05 | Rejected (Covered by Opaque Handles in RFC-026) |
...
| **Accepted** | `rfc/accepted/` | Approved and ready for implementation |
