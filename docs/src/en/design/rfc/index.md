...
|------|------|------|----------|------|
| RFC-019 | [RFC-019: Type-Level Homoiconicity (Typed Homoiconicity) - Syntax as Type](./draft/019-typed-homoiconicity.md) | 晨煦 (Chen Xu) | 2026-02-20 | Draft |
...
| Number | Title | Author | Created | Status |
|------|------|------|----------|------|
| RFC-025 | [RFC-025: Extensible Primitive Type Mechanism](./review/025-primitive-extension.md) | 晨煦 (Chen Xu) | 2026-06-05 | Under Review |
| RFC-026 | [RFC-026: FFI Core Mechanism](./review/026-ffi-core-mechanism.md) | 晨煦 (Chen Xu) | 2026-06-05 | Under Review |
...
| Number | Title | Author | Created | Status |
|------|------|------|----------|------|
| RFC-004 | [RFC-004: Multi-Position Union Binding Design for Curried Methods](./accepted/004-curry-multi-position-binding.md) | 晨煦 (Chen Xu) | 2025-01-05 | Accepted |
...
| RFC-007 | [RFC-007: Unified Function Definition Syntax](./accepted/007-function-syntax-unification.md) | 沫郁酱 (Mo Yu) | 2025-01-05 | Accepted |
| RFC-008 | [RFC-008: Decoupling Design of Runtime Concurrency Model and Scheduler](./accepted/008-runtime-concurrency-model.md) | 晨煦 (Chen Xu) | 2025-01-05 | Accepted |
...
| RFC-011 | [RFC-011: Generics System Design - Zero-Cost Abstraction and Macro Replacement](./accepted/011-generic-type-system.md) | 晨煦 (Chen Xu) | 2025-01-25 | Accepted |
...
| RFC-023 | [RFC-023: Closure Capture Model](./accepted/023-closure-capture-model.md) | 晨煦 (Chen Xu) | 2026-05-29 | Accepted |
| RFC-024 | [RFC-024: Concurrency Model Based on `spawn` Blocks](./accepted/024-concurrency-model.md) | 晨煦 (Chen Xu) | 2026-06-05 | Accepted |
...
| Number | Title | Author | Created | Status |
|------|------|------|----------|------|
| RFC-001 | [RFC-001: spawn Model and Error Handling System](./deprecated/001-concurrent-model-error-handling.md) | 晨煦 (Chen Xu) | 2025-01-05 | Deprecated (Superseded by RFC-024) |
| RFC-020 | [RFC-020: Dynamic Modules and FFI Integration](./deprecated/020-dynamic-modules-ffi.md) | 晨煦 (Chen Xu) (Based on community discussion) | 2026-03-14 | Deprecated |
...
| Number | Title | Author | Created | Status |
|------|------|------|----------|------|
| RFC-002 | [RFC-002: Cross-Platform I/O and libuv Integration](./rejected/002-cross-platform-io-libuv.md) | 晨煦 (Chen Xu) | 2025-01-05 | Rejected |
...
| **Deprecated** | `rfc/deprecated/` | Was previously accepted but superseded by a new design |
...
1. Read [RFC_TEMPLATE.md](RFC_TEMPLATE.md) for formatting requirements
...
5. Update this index file with a new RFC entry
