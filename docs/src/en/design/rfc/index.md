...
| RFC-025 | [RFC-025: Extensible Primitive Type Mechanism](./rejected/025-primitive-extension.md) | Chen Xu | 2026-06-05 | Rejected (Superseded by RFC-026 Opaque Handles) |
...
|------|------|------|
| **Draft** | `rfc/draft/` | Author draft, awaiting review submission |
...
5. Update this index file, adding new RFC entries
