...
> An RFC (Request for Comments) is the formal submission format for YaoXiang language feature design proposals.
...
| RFC-028 | [RFC-028: JIT Compiler — Multi-Level Execution Engine in the VM](./draft/028-jit-compiler.md) | Chen Xu | 2026-06-11 | Draft |
...
| **Accepted** | `rfc/accepted/` | Becomes a formal design document, entering the implementation phase |
