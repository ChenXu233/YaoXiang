...
single-layer numbering system similar to Rust, combined with JSON resource files to support multiple
...
3. **Tool Integration**: IDEs/LSPs can offer quick-fix suggestions and documentation links based on
   error codes
