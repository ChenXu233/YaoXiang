...
- **Incremental Delivery**: Every version has usable functionality
- **Backward Compatibility**: APIs may change before v1.0, but advance notice will be given
...
- Lexer → Parser → TypeChecker → Codegen step-by-step replacement
