...
description:
  The general behavior specification for the YaoXiang code formatting tool (yaoxiang fmt), defining
...
**Principle 1: Formatting is idempotent.** Formatting already formatted code must produce output
...
documentation comments must be preserved and shall not be deleted or modified.
