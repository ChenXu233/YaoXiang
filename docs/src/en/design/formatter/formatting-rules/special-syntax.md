...
description: 'Formatting rules for F-String, import statements, error handling, and Unsafe blocks'
---
...
**§13.2 Formatting Specifications.** F-String supports formatting specifications `{expr:spec}`.
...
**§14.2 In-group Sorting.** Imports within the same group are sorted alphabetically.
