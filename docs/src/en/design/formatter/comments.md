...
**§C1.2 Multi-line comments.** Must be surrounded by `/* ... */`, with support for nesting, and must
be preserved.
...
**§C3.1 Empty line preservation.** Empty lines in the original source code should be preserved to
