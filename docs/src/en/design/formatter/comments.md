...
**§C2.1 File header comments.** Comments at the beginning of a file must be preserved at the start of the file.

**§C2.2 Inter-statement comments.** Comments between statements must be preserved in their original position.
...
**§C3.1 Empty line preservation.** Empty lines in the original code should be preserved to separate logical blocks.
