...
- [Concurrency Model](./concurrency.md) - Async programming, concurrency primitives, memory model
- [Standard Library](./stdlib.md) - Core library, IO library, math library

## Overview

This specification defines the core syntax and semantics of the YaoXiang programming language. It serves as the authoritative reference for the language, targeted at compiler and tool implementers.
