...
- [Module System](./modules.md) - Module definitions, imports/exports, scope
...
This specification defines the core syntax and semantics of the YaoXiang programming language. It
serves as the authoritative reference for the language, targeting compiler and tool implementers.
...
4. **Concurrency Model**: Defines the concurrency model of the language, including asynchronous
   programming, concurrency primitives, and memory model
5. **Standard Library**: Defines the standard library of the language, including core library, IO
...
- [YaoXiang Guide](../../guide/YaoXiang-book.md) - Tutorials and example code
