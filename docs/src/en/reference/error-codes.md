...
matching, generics instantiation, concurrency semantics, and error propagation.
...
and function signature parsing.
...
Internal compiler errors, usually indicating a bug in the compiler itself. If you encounter such
...
Dead code detection related warnings. Warnings do not prevent compilation but indicate possible
issues in the code.
