...
| E1081 | `` `?` is only allowed inside functions returning Result ``                        | `?` only allowed inside functions returning Result                |
...
| E5007 | `Module '{module}' exports: {available}`           | Module exports hint |
...
Internal compiler errors, which usually indicate a bug in the compiler itself. If you encounter such
an error, please report it on [GitHub Issues](https://github.com/yaoxiang/yaoxiang/issues).
