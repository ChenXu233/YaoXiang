...
ability to "make decisions" and "execute repeatedly"—this is **control flow**.
...
The following sections will dive into each kind of control flow one by one. It is recommended to
read them in order, since there is a natural progressive relationship among them.
